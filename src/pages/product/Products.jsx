...
const Products = () => {
  ...
  const { data, loading } = useAsync(() =>
    ProductServices.getAllProducts(domain)
  );
  ...
  const { serviceData, handleOnDrop, handleUploadProducts, totalResults } =
    useFilter(data?.data);
  ...
  return (
    <>
      ...
      {/* <MainDrawer><ProductDrawer /></MainDrawer> */}
          ...
          <Table>
            <TableHeader>
              <tr>
                ...
                <TableCell>Price (min-max)</TableCell>
